...
public class HostInfo
{
     ...
     * 主机DNS配置信息。
     */
    private HostDNSCfg hostDNSCfg;
    
    /**
     * 主机路由表，路由条数，最大128条。
     */
    private List<HostRoutetable> hostRoutetable;
    ...
    public HostDNSCfg getHostDNSCfg()
    {
        return hostDNSCfg;
    }
    
    public void setHostDNSCfg(HostDNSCfg hostDNSCfg)
    {
        this.hostDNSCfg = hostDNSCfg;
    }
    
    public List<HostRoutetable> getHostRoutetable()
    {
        return hostRoutetable;
    }
    
    public void setHostRoutetable(List<HostRoutetable> hostRoutetable)
    {
        this.hostRoutetable = hostRoutetable;
    }
